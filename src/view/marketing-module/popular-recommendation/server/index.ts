...
export function fetchConfig(params: FetchConfigParams) {
    return get<FetchConfigResolve>(`/api/home/recommendProduct/list`, { ...params });
}

// 是否推荐
export function updateRecommendStatus(params: UpdateStatusType) {
    return post<Response>(`/api/home/recommendProduct/update/recommendStatus`, { ...params });
}
...
export function recommendSubjecDelete(ids: string) {
    ...
    return post<Response>('/api/home/recommendProduct/delete', formData, { headers: {
